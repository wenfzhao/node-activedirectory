...
function getGroupMembershipForDN(opts, dn, stack, callback) {
  ...
  search.call(self, opts, function(err, results) {
    ...
    var groups = [];
    // changed from async.forEach to async.forEachLimit to resolve https://github.com/gheeres/node-activedirectory/issues/209
    async.forEachLimit(results, 5, function(group, asyncCallback) {
